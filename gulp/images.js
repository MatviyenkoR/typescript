(function() {
    ...
    var tasks = {
        ...
        spritesPng: {
            enable: false,
            watch: ['app/images/sprites/**/*.png', 'gulp/templates/fa.sprites.mustache'],
        ...
        copyMedia: {
            watch: ['app/media/**/*', '!app/media/**/*.'],
            input: ['app/media/**/*', '!app/media/**/*.'],
            output: 'dist/media/'
        },
    ...
    gulp.task('spritesPng', function () {
         var spriteData = gulp.src(tasks.spritesPng.input)
            ...
            .pipe(spritesmith({
                ...
                cssTemplate: 'gulp/templates/fa.sprites.mustache',
